...
function AppMain({ currentUser, onLogout }: { currentUser: User; onLogout: () => void }) {
  ...
  // Static height: 6 paddler rows at 28px each
  const canoeRowHeight = 6 * 28; // 168px
                ...
                <div style={{ position: 'sticky', top: 0, zIndex: 20, backgroundColor: '#000000', padding: '12px 4px 0 4px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', padding: '8px 4px', flex: 1 }}>
                    ...
                    <div style={{ marginTop: 'auto', paddingTop: '16px', borderTop: '1px solid #4b5563' }}>
                      <a
                        href="https://discord.gg/tjp6BgY2"
                        target="_blank"
                      ...
                      >
                        <span style={{ fontSize: '22px', lineHeight: 1, width: '20px', textAlign: 'center', flexShrink: 0 }}>
                        ...
                        {leftSidebarOpen && <span style={{ fontSize: '15px', fontWeight: 500 }}>discord</span>}
                      </a>
                      {leftSidebarOpen && (
                        <>
                              ...
                              <Droppable droppableId={`canoe-${canoe.id}-seat-${seat}`} key={seat}>
                                {(provided, snapshot) => (
                                  <div
                                    ...
                                    style={{ position: 'relative', height: '28px', minHeight: '28px', display: 'flex', alignItems: 'center' }}
                                  >
